...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostaessa_kaksi_eri_tuotetta_pankin_metodia_tilisiirto_kutsutaan_oikeilla_argumenteilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            if tuote_id == 2:
    ...
    def test_ostaessa_kaksi_tuotetta_joista_toinen_loppu_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            
        def tyhjenna_varasto(tuote_id):
            if tuote_id == 1:
                return 0
        ...
        self.varasto_mock.saldo.side_effect = tyhjenna_varasto
        kauppa.lisaa_koriin(1)
        kauppa.tilimaksu("pekka", "12345")
